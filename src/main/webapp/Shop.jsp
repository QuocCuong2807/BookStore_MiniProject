				...
				<div class="border-bottom mb-4 pb-4">
					...
					<div>
						<div class="custom-control mb-3">
							<p>
								<a name="price-all" href="category?categoryId=All">All</a>
							</p>
							<c:forEach items="${categoryList}" var="o">
								<p>
									<a name="price-${o.categoryId}"
						...
						<div class="col-lg-4 col-md-6 col-sm-12 pb-1">
							<div class="card product-item border-0 mb-4">
								<div
									...
									<img class="img-fluid w-100" src="${o.images}" alt="">
								</div>
								<div
									class="card-body border-left border-right text-center p-0 pt-4 pb-3">
									<h6 class="text-truncate mb-3">${o.bookName}</h6>
									<div class="d-flex justify-content-center">
										<c:choose>
											<c:when test="${o.discount > 0}">
												<h6>${o.bookPrice - (o.bookPrice * o.discount/100)}VND</h6>
												<h6 class="text-muted ml-2">
													<del>${o.bookPrice} VND</del>
												</h6>
											</c:when>
											<c:otherwise>
												<h6>${o.bookPrice}VND</h6>
											</c:otherwise>
										</c:choose>
									</div>
								</div>
								<div
									...
									<a href="" class="btn btn-sm text-dark p-0"><i
										...
										href="addToCart?bookId=${o.bookId }"
