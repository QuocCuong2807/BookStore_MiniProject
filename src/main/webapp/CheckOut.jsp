...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row align-items-center py-3 px-xl-5 d-flex">
			<div class="col-lg-3 d-none d-lg-block ">
				<a href="" class="text-decoration-none">
					<h1 class="m-0 display-5 font-weight-semi-bold">
						<a href="Shop" class="text-primary font-weight-bold border px-3 mr-1">E</a>Shopper
					</h1>
				</a>
			</div>
			<%
			Customer customer = (Customer) session.getAttribute("customer");
			String e_fullname = request.getAttribute("e_cusFullName") + "";
			String e_phoneNumber = request.getAttribute("e_cusPhoneNumber") + "";
			String e_address = request.getAttribute("e_cusAddress") + "";

			e_fullname = (e_fullname == null || e_fullname.equals("null")) ? "" : e_fullname;
			e_phoneNumber = (e_phoneNumber == null || e_phoneNumber.equals("null")) ? "" : e_phoneNumber;
			e_address = (e_address == null || e_address.equals("null")) ? "" : e_address;
			%>
			<c:set var="cus" value="<%=customer%>"></c:set>
			<c:choose>
				<c:when test="${cus == null }">
					<div class="col-lg-3 col-6 text-right">
						<a href="do-login" class="nav-item nav-link">Login</a> <a href="Login.jsp"
							class="nav-item nav-link">Register</a> <a href="Register.jsp"
	...
	<div class="container-fluid pt-5 d-flex">
		<form class="row px-xl-5" action="save-order" method="post">
			<div class="col-lg-8">
				<div class="mb-4">
						...
						<c:if test="${cus == null }">
							<div class="col-md-12 form-group">
								<label>Full Name</label> <input class="form-control" type="text"
									placeholder="Full Name..." name="customerName"
									value="${ cusFullName}">
							</div>
						</c:if>
						<span class="rq"><%=e_fullname%></span>


						<div class="col-md-12 form-group">
							<label>Mobile No</label> <input class="form-control" type="text"
								name="phoneNumber" value="" placeholder="+123 456 789">
						</div>
						<span class="rq"><%=e_phoneNumber%></span>
						<div class="col-md-12 form-group">
							<label>Address </label> <input class="form-control"
								name="address" value="" type="text" placeholder="123 Street...">
						</div>
						<span class="rq"><%=e_address%></span>
						<div class="col-md-6 form-group">
							<label>Country</label> <select class="custom-select"
								name="country">
								<option selected value="Viet Nam">Viet Name</option>
							</select>
						</div>
						<div class="col-md-6 form-group">
							<label>City</label> <select class="custom-select" name="city">
								<option selected value="tp.Ho Chi Minh">Ho Chi Minh</option>
								<option selected value="tp.Ha Noi">Ha Noi</option>
								<option selected value="tp.Da Nang">Da Nang</option>
								<option selected value="tp.Hai Phong">Hai Phong</option>
								<option selected value="tp.Can Tho">Can Tho</option>
							</select>
						</div>
						<div class="col-md-6 form-group">
							<label>Note</label> <input class="form-control" type="text"
								name="note" value="" placeholder="Add some note...">
						</div>
					</div>
				</div>
				...
				<div class="card border-secondary mb-5">
					...
					<div class="card-body">
						...
						<c:if test="${cart!=null }">
							...
							<c:forEach items="<%=entrySet%>" var="o">
								<div class="d-flex justify-content-between">
									<p>${o.getValue().getBook().getBookName() }</p>
									<p>${o.getValue().getQuantity() }</p>
									<p>${cart.getPrice(o.getValue().getBook().getBookId()) }</p>
								</div>
							</c:forEach>
						</c:if>
						...
						<div class="d-flex justify-content-between mb-3 pt-1">
							...
							<h6 class="font-weight-medium">${cart.getTotalPrice() }vnd</h6>
						</div>
						<div class="d-flex justify-content-between">
					...
					<div class="card-footer border-secondary bg-transparent">
						<div class="d-flex justify-content-between mt-2">
							...
							<h5 class="font-weight-bold">${cart.getTotalPrice() + 10}</h5>
						</div>
					</div>
				</div>
				<div class="card border-secondary mb-5">
